# test_primal_dual_non_stationary.py
...
print("🧪 Testing Primal-Dual Algorithm (per-product) with Highly Non-Stationary Environment")
print("=" * 60)

# Initialise l’environnement non-stationnaire
